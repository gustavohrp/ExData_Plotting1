...
par(mfrow=c(2,2))
plot(data.sub$DateTime, data.sub$Global_active_power, type = "l", col = "black", xlab = "", ylab = "Global Active Power")
plot(data.sub$DateTime, data.sub$Voltage, type = "l", col = "black", xlab = "datetime", ylab = "Voltage")
...
plot(data.sub$DateTime, data.sub$Global_reactive_power, type = "l", col = "black", xlab = "datetime", ylab = "Global_reactive_power")
